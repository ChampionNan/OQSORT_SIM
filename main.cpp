...
int quantileCal(int *samples, int start, int end, int p, int *trustedM1) {
...
std::pair<int, int> MultiLevelPartition(int inStructureId, int *samples, int sampleSize, int p, int outStructureId1) {
  ...
  bool resFlag = quantileCal(samples, 0, sampleSize, p0, trustedM1);
  while (!resFlag) {
    std::cout << "Quantile calculate error!\n";
    resFlag = quantileCal(samples, 0, sampleSize, p0, trustedM1);
  }
